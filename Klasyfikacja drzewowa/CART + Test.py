#Porównanie działania obu algorytmów - testowego i autorskiego - w celu testowania wyników
...
for element in y_test:
    if element in new_dictionary:
        new_dictionary[element] = new_dictionary[element] + 1
    else:
        new_dictionary[element] = 1
sorted_dict = dict(sorted(new_dictionary.items()))
